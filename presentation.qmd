...
![](images/banner_4.png){.banner-image style="max-width: 100%; height: auto;"}
:::
...
::: {.custom-box style="border: 2px solid black; border-radius: 12px; padding: 15px 20px; max-width: 800px; font-family: Arial, sans-serif; font-size: 2rem; line-height: 1.5; background-color: #fafafa;"}
...
<h3 style="font-size: 32px; color: #2A9D8F; font-weight: bold; margin: 0px;">Question 1</h3>

<span style="font-size: 25px; margin: 0px;">Top 10 Counties with Highest Plumbing Insecurity in 2022 and 2023</span>
...
### Question 2
::: cell_text_block
**Top U.S. Counties in Hotspot and Coldspot Clusters of Plumbing Insecurity (2022–2023)?**
<br>
This analysis focuses on measuring year-over-year changes in plumbing insecurity across U.S. counties and identifying spatial clusters of significant improvement or decline, in order to understand where regional shifts in plumbing access are occurring and whether those shifts follow meaningful geographic patterns.
:::
<!--Slide 9 -->
